...
import "./VotingControllerStorageUpgMock.sol";
...
contract PendleVotingControllerUpgMock is
    PendleMsgSenderAppUpg,
    VotingControllerStorageUpgMock,
    UUPSUpgradeable
{
    ...
    constructor(
        ...
        VotingControllerStorageUpgMock(_vePendle)
