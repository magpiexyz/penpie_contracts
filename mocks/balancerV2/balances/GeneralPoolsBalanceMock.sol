...
abstract contract GeneralPoolsBalanceMock {
    ...
    function _generalPoolCashToManaged(
        ...
        _updateGeneralPoolBalance(poolId, token, BalanceAllocationMock.cashToManaged, amount);
    }
    ...
    function _generalPoolManagedToCash(
        ...
        _updateGeneralPoolBalance(poolId, token, BalanceAllocationMock.managedToCash, amount);
    }
    ...
    function _setGeneralPoolManagedBalance(
        ...
        return _updateGeneralPoolBalance(poolId, token, BalanceAllocationMock.setManaged, amount);
    }
