...
abstract contract TwoTokenPoolsBalanceMock is PoolRegistryMock {
    ...
    function _setTwoTokenPoolCashBalances(
        ...
        poolBalances.sharedCash = BalanceAllocationMock.toSharedCash(balanceA, balanceB);
    }
    ...
    function _twoTokenPoolCashToManaged(
        ...
        _updateTwoTokenPoolSharedBalance(poolId, token, BalanceAllocationMock.cashToManaged, amount);
    }
    ...
    function _twoTokenPoolManagedToCash(
        ...
        _updateTwoTokenPoolSharedBalance(poolId, token, BalanceAllocationMock.managedToCash, amount);
    }
    ...
    function _setTwoTokenPoolManagedBalance(
        ...
        return _updateTwoTokenPoolSharedBalance(poolId, token, BalanceAllocationMock.setManaged, amount);
    }
    ...
    function _updateTwoTokenPoolSharedBalance(
        ...
        balances.sharedCash = BalanceAllocationMock.toSharedCash(balanceA, balanceB);
        balances.sharedManaged = BalanceAllocationMock.toSharedManaged(balanceA, balanceB);
        ...
        )
    {
        ...
        balanceA = BalanceAllocationMock.fromSharedToBalanceA(sharedCash, sharedManaged);
        balanceB = BalanceAllocationMock.fromSharedToBalanceB(sharedCash, sharedManaged);
    }
